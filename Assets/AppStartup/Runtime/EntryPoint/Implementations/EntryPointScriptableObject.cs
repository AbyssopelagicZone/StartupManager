...
{
	[CreateAssetMenu(fileName = "EntryPoint", menuName = "Startup Manager/Entry Point Scriptable Object")]
	public class EntryPointScriptableObject : ScriptableObject, IEntryPoint
	{
		#region UnitySerialized
		[SerializeField]
		private EntryPointSettings settings;
		...
		protected void AddProgressReceiver(IProgressReceiver progressReceiver)
		{
